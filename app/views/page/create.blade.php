...
<div class="row">
	<div class="col-md-10 col-md-offset-1">
		...
		<div class="panel panel-default">
			...
			{{Form::open(array('route'=>'page.store','id' => "myform"))}}
		         <div class="form-group">
		            <label>Page title</label>  
		            {{Form::text('page_title','',array('class'=>'form-control','placeholder' => 'Page title'))}}
		            <span id="message">
		         ...
		         <div class="form-group">
		            <label>Body</label>  
		            {{Form::textarea('page_content','',array('class'=>'form-control','placeholder' => 'First name'))}}
		            <span id="message">
		         ...
		         <div class="form-group">
		            ...
		            {{Form::select('menu_id',$menu,'0',array('id' => 'menu','class' => 'form-control','onchange' => 'sub_menu(this.value)'))}}
		            <span id="message">
		         ...
		         <div class="form-group" id="sub_menu">
		            ...
		            {{Form::select('sub_menu_id',$sub_menu,'0',array('id' => 'menu','class' => 'form-control'))}}
		            <span id="message">
